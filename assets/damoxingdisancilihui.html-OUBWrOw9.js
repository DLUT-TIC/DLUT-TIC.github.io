import{_ as n,o as s,c as a,b as e}from"./app-CkhODGpz.js";const t={},i=e(`<h1 id="from-吴恩达-openai联合prompt课程" tabindex="-1"><a class="header-anchor" href="#from-吴恩达-openai联合prompt课程"><span>From 吴恩达，OpenAI联合prompt课程</span></a></h1><ul><li>https://www.youtube.com/watch?v=X3rIkx4r5vk</li><li>https://learn.deeplearning.ai/courses/chatgpt-prompt-eng/lesson/1/introduction</li></ul><h2 id="preparation" tabindex="-1"><a class="header-anchor" href="#preparation"><span>Preparation</span></a></h2><div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre class="language-python"><code><span class="line"><span class="token comment">#!pip install openai</span></span>
...
</code></pre><p>实际上对了但是没有完全对 尝试修复</p><div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre class="language-python"><code><span class="line">prompt <span class="token operator">=</span> <span class="token string-interpolation"><span class="token string">f&quot;&quot;</span></span>&quot;</span>
<span class="line">Your task <span class="token keyword">is</span> to determine <span class="token keyword">if</span> the student&#39;s solution \\</span>
<span class="line"><span class="token keyword">is</span> correct <span class="token keyword">or</span> <span class="token keyword">not</span><span class="token punctuation">.</span></span>
<span class="line">To solve the problem do the following<span class="token punctuation">:</span></span>
<span class="line"><span class="token operator">-</span> First<span class="token punctuation">,</span> work out your own solution to the problem including the final total<span class="token punctuation">.</span> </span>
<span class="line"><span class="token operator">-</span> Then compare your solution to the student&#39;s solution \\ </span>
<span class="line"><span class="token keyword">and</span> evaluate <span class="token keyword">if</span> the student&#39;s solution <span class="token keyword">is</span> correct <span class="token keyword">or</span> <span class="token keyword">not</span><span class="token punctuation">.</span> </span>
<span class="line">Don<span class="token string">&#39;t decide if the student&#39;</span>s solution <span class="token keyword">is</span> correct until </span>
<span class="line">you have done the problem yourself<span class="token punctuation">.</span></span>
<span class="line"></span>
<span class="line">Use the following <span class="token builtin">format</span><span class="token punctuation">:</span></span>
<span class="line">Question<span class="token punctuation">:</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>question here</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">Student&#39;s solution:</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>student&#39;s solution here</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">Actual solution:</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>steps to work out the solution and your solution here</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">Is the student&#39;s solution the same as actual solution \\</span>
<span class="line">just calculated:</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><p>yes or no</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">Student grade:</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>correct or incorrect</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line"></span>
<span class="line">Question:</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><p>I&#39;m building a solar power installation and I need help <br> working out the financials.</p><ul><li>Land costs $100 / square foot</li><li>I can buy solar panels for $250 / square foot</li><li>I negotiated a contract for maintenance that will cost <br> me a flat $100k per year, and an additional $10 / square <br> foot What is the total cost for the first year of operations <br> as a function of the number of square feet.</li></ul><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">Student&#39;s solution:</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>Let x be the size of the installation in square feet. Costs:</p><ol><li>Land cost: 100x</li><li>Solar panel cost: 250x</li><li>Maintenance cost: 100,000 + 100x Total cost: 100x + 250x + 100,000 + 10x = 370x + 100,000</li></ol><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">Actual solution:</span>
<span class="line">&quot;&quot;&quot;</span>
<span class="line">response = get_completion(prompt)</span>
<span class="line">print(response)</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><pre><code>&lt;&gt;:56: SyntaxWarning: invalid escape sequence &#39;\\ &#39;
