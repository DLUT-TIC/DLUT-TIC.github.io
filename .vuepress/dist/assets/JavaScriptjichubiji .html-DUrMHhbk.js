import{_ as d,r as t,o as r,c as p,b as i,d as n,e,a as l}from"./app-COWjHGTC.js";const c={},o={href:"https://wikipedia.org/wiki/Node.js",target:"_blank",rel:"noopener noreferrer"},u={href:"https://en.wikipedia.org/wiki/Ajax_(programming)",target:"_blank",rel:"noopener noreferrer"},v={href:"https://en.wikipedia.org/wiki/Comet_(programming)",target:"_blank",rel:"noopener noreferrer"},m={href:"https://www.dartlang.org/",target:"_blank",rel:"noopener noreferrer"},b={href:"https://kotlinlang.org/docs/reference/js-overview.html",target:"_blank",rel:"noopener noreferrer"},g={href:"https://en.wikipedia.org/wiki/Web_cache",target:"_blank",rel:"noopener noreferrer"},h={href:"https://lodash.com/docs#cloneDeep",target:"_blank",rel:"noopener noreferrer"},S={href:"https://zh.javascript.info/date",target:"_blank",rel:"noopener noreferrer"};function y(J,s){const a=t("ExternalLinkIcon");return r(),p("div",null,[s[43]||(s[43]=i('<h1 id="简介" tabindex="-1"><a class="header-anchor" href="#简介"><span>简介：</span></a></h1><h2 id="js简介" tabindex="-1"><a class="header-anchor" href="#js简介"><span>JS简介：</span></a></h2><h3 id="什么是js" tabindex="-1"><a class="header-anchor" href="#什么是js"><span>什么是JS：</span></a></h3><p>JS编程语言写出来的程序被称为<strong>脚本</strong> 它们可以被直接写在网页的 HTML 中，在页面加载的时候自动执行。脚本被以纯文本的形式提供和执行。它们不需要特殊的准备或编译即可运行。</p><p><strong>浏览器嵌入了一种JavaScript引擎（在这里我们把JavaScript引擎称为<strong><strong>JS</strong></strong>引擎，又称为：JavaScript<strong><strong>虚拟机</strong></strong>），而JS引擎它可以把JS代码解析成浏览器能够识别的代码，因此JS代码可以在含有JS引擎的浏览器中运行。</strong></p><p>不同的JS引擎有不同的代号，例如：</p><p>Chrome 和 Opera 中的 JS引擎------V8引擎</p><p><strong>引擎是如何工作的？</strong></p><p>引擎很复杂，但是基本原理很简单。</p><ol><li><p>引擎（如果是浏览器，则引擎被嵌入在其中）读取（“解析”）脚本。</p></li><li><p>然后，引擎将脚本转化（“编译”）为机器语言。</p></li><li><p>然后，机器代码快速地执行。</p></li></ol><h3 id="js功能" tabindex="-1"><a class="header-anchor" href="#js功能"><span>JS功能：</span></a></h3>',11)),n("p",null,[s[1]||(s[1]=e("现代的 JavaScript 是一种“安全的”编程语言。")),s[2]||(s[2]=n("strong",null,"它不提供对内存或",-1)),s[3]||(s[3]=e()),s[4]||(s[4]=n("strong",null,"CPU",-1)),s[5]||(s[5]=e()),s[6]||(s[6]=n("strong",null,"的底层访问",-1)),s[7]||(s[7]=e("。JavaScript 的能力很大程度上取决于它运行的环境。例如，")),n("a",o,[s[0]||(s[0]=e("Node.js")),l(a)]),s[8]||(s[8]=e(" 支持允许 JavaScript 读取/写入任意文件，执行网络请求等的函数。")),s[9]||(s[9]=n("strong",null,"浏览器中的 JavaScript 可以做与网页操作、用户交互和 Web 服务器相关的所有事情。",-1))]),s[44]||(s[44]=n("ol",null,[n("li",null,"浏览器中的 JavaScript 可以做下面这些事：")],-1)),n("ul",null,[s[19]||(s[19]=n("li",null,[n("p",null,"在网页中添加新的 HTML，修改网页已有内容和网页的样式。")],-1)),s[20]||(s[20]=n("li",null,[n("p",null,"响应用户的行为，响应鼠标的点击，指针的移动，按键的按动。")],-1)),n("li",null,[n("p",null,[s[12]||(s[12]=e("向远程服务器发送网络请求，下载和上传文件（所谓的 ")),n("a",u,[s[10]||(s[10]=e("AJAX")),l(a)]),s[13]||(s[13]=e(" 和 ")),n("a",v,[s[11]||(s[11]=e("COMET")),l(a)]),s[14]||(s[14]=e(" 技术）。"))])]),s[21]||(s[21]=n("li",null,[n("p",null,"获取或设置 cookie，向访问者提出问题或发送消息。")],-1)),s[22]||(s[22]=n("li",null,[n("p",null,"记住客户端的数据（“本地存储”）。"),n("ul",null,[n("li",null,"为了用户的（信息）安全，在浏览器中的 JavaScript 的能力是受限的。目的是防止恶意网页获取用户私人信息或损害用户数据。")])],-1)),s[23]||(s[23]=n("li",null,[n("p",null,"网页中的 JavaScript 不能读、写、复制和执行硬盘上的任意文件。它没有直接访问操作系统的功能。")],-1)),s[24]||(s[24]=n("li",null,[n("p",null,"不同的标签页/窗口之间通常互不了解。有时候，也会有一些联系，例如一个标签页通过 JavaScript 打开的另外一个标签页。但即使在这种情况下，如果两个标签页打开的不是同一个网站（域名、协议或者端口任一不相同的网站），它们都不能相互通信。")],-1)),s[25]||(s[25]=n("li",null,[n("p",null,"JavaScript 可以轻松地通过互联网与当前页面所在的服务器进行通信。但是从其他网站/域的服务器中接收数据的能力被削弱了。尽管可以，但是需要来自远程服务器的明确协议（在 HTTP header 中）。这也是为了用户的信息安全。")],-1)),n("li",null,[n("p",null,[n("a",m,[s[15]||(s[15]=e("Dart")),l(a)]),s[16]||(s[16]=e(" 是一门独立的语言。它拥有自己的引擎，该引擎可以在非浏览器环境中运行（例如手机应用），它也可以被编译成 JavaScript。由 Google 开发。"))])]),n("li",null,[n("p",null,[n("a",b,[s[17]||(s[17]=e("Kotlin")),l(a)]),s[18]||(s[18]=e(" 是一个现代、简洁且安全的编程语言，编写出的应用程序可以在浏览器和 Node 环境中运行。"))])])]),s[45]||(s[45]=i(`<p>这些语言在浏览器中执行之前，都会被 <strong>编译</strong>（转化）成 JavaScript。</p><h1 id="js基础知识" tabindex="-1"><a class="header-anchor" href="#js基础知识"><span>JS基础知识：</span></a></h1><h2 id="js代码位置" tabindex="-1"><a class="header-anchor" href="#js代码位置"><span>JS代码位置：</span></a></h2><ul><li><p>对于服务器端环境（如 Node.js），你只需要使用诸如 <code>&quot;node ---.js&quot;</code> 的命令行来执行它。</p></li><li><p>客户端环境中，使用 <code>&lt;script&gt;</code> 标签将 JavaScript 程序插入到 HTML 文档的任何位置。</p></li></ul><div class="language-JavaScript line-numbers-mode" data-highlighter="prismjs" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">&lt;!DOCTYPE HTML&gt;</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,64)),n("p",null,[s[30]||(s[30]=e("为了创建“真正的拷贝”（一个克隆），我们可以使用 ")),s[31]||(s[31]=n("code",null,"Object.assign",-1)),s[32]||(s[32]=e(" 来做所谓的“浅拷贝”（嵌套对象被通过引用进行拷贝）或者使用“深拷贝”函数，例如 ")),n("a",h,[s[29]||(s[29]=e("_.cloneDeep(obj)")),l(a)]),s[33]||(s[33]=e("。"))]),s[47]||(s[47]=i(`<div class="language-JavaScript line-numbers-mode" data-highlighter="prismjs" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">Object.assign(dest, [src1, src2, src3...])</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="对象———原始值转换" tabindex="-1"><a class="header-anchor" href="#对象———原始值转换"><span>对象———原始值转换</span></a></h2><h2 id="基本不会用到-想更深理解js的可以看看" tabindex="-1"><a class="header-anchor" href="#基本不会用到-想更深理解js的可以看看"><span>(基本不会用到，想更深理解JS的可以看看)</span></a></h2><h3 id="转换规则" tabindex="-1"><a class="header-anchor" href="#转换规则"><span>转换规则：</span></a></h3>`,68)),n("ol",null,[s[41]||(s[41]=n("li",null,[n("p",null,[e("没有转换为布尔值。所有的对象在布尔上下文（context）中均为 "),n("code",null,"true"),e("，就这么简单。只有字符串和数字转换。")])],-1)),n("li",null,[n("p",null,[s[35]||(s[35]=e("数字转换发生在对象相减或应用数学函数时。例如，")),s[36]||(s[36]=n("code",null,"Date",-1)),s[37]||(s[37]=e(" 对象（将在 ")),n("a",S,[s[34]||(s[34]=e("日期和时间")),l(a)]),s[38]||(s[38]=e(" 一章中介绍）可以相减，")),s[39]||(s[39]=n("code",null,"date1 - date2",-1)),s[40]||(s[40]=e(" 的结果是两个日期之间的差值。"))])]),s[42]||(s[42]=n("li",null,[n("p",null,[e("至于字符串转换 —— 通常发生在我们像 "),n("code",null,"alert(obj)"),e(" 这样输出一个对象和类似的上下文中。")])],-1))]),s[48]||(s[48]=i(`<p>我们可以使用特殊的对象方法，自己实现字符串和数字的转换。</p><h3 id="hint" tabindex="-1"><a class="header-anchor" href="#hint"><span>hint：</span></a></h3><p>当我们对期望一个字符串的对象执行操作时，如 “alert”，对象到字符串的转换。<strong>&quot;string&quot;</strong></p><div class="language-JavaScript line-numbers-mode" data-highlighter="prismjs" data-ext="JavaScript" data-title="JavaScript"><pre class="language-JavaScript"><code><span class="line">// 输出</span>
