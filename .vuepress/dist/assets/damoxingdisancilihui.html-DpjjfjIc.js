import{_ as i,r as l,o as p,c as o,d as s,e,a as t,b as c}from"./app-COWjHGTC.js";const r={},u={href:"https://www.youtube.com/watch?v=X3rIkx4r5vk",target:"_blank",rel:"noopener noreferrer"},d={href:"https://learn.deeplearning.ai/courses/chatgpt-prompt-eng/lesson/1/introduction",target:"_blank",rel:"noopener noreferrer"};function m(v,n){const a=l("ExternalLinkIcon");return p(),o("div",null,[n[2]||(n[2]=s("h1",{id:"from-吴恩达-openai联合prompt课程",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#from-吴恩达-openai联合prompt课程"},[s("span",null,"From 吴恩达，OpenAI联合prompt课程")])],-1)),s("ul",null,[s("li",null,[s("a",u,[n[0]||(n[0]=e("视频链接")),t(a)])]),s("li",null,[s("a",d,[n[1]||(n[1]=e("课程链接")),t(a)])])]),n[3]||(n[3]=c(`<h2 id="preparation" tabindex="-1"><a class="header-anchor" href="#preparation"><span>Preparation</span></a></h2><div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre class="language-python"><code><span class="line"><span class="token comment">#!pip install openai</span></span>
